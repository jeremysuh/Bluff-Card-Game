...
public class MenuScreen implements InputProcessor, Screen{
    ...
    public MenuScreen(Bluff bluff, SpriteBatch batch) {
        ...
        playButton = new Button(ResourceManager.playButton,400-75,200,150,150);
    ...
    public boolean touchUp(int screenX, int screenY, int pointer, int button) {
        ...
        for (Button b: buttonContainer){
            ...
            if (b.equals(playButton) && playButton.isPressed() && pointer == 0){
